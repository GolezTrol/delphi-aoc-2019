...
type
  ...
  public
    ...
    [TestCase('Relative base', '109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99|109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99', '|')]
    [TestCase('Large numbers 1', '1102,34915192,34915192,7,4,7,99,0|1219070632396864', '|')]
    [TestCase('Large numbers 2', '104,1125899906842624,99|1125899906842624', '|')]
...
begin
  ...
  Assert.AreEqualIntArrays(TInput.IntCommaSeparated(Expected), Outputs);
end;
